  ...
  return (
    <div className="perspective-1000 w-full group">
      <motion.div 
        ...
        className="w-full glass-card overflow-hidden font-mono text-sm relative preserve-3d"
      >
        <div className="bg-foreground/10 px-4 py-2 flex items-center gap-2">
          ...
          <div className="text-xs text-foreground/40 ml-2">bash — contact.sh</div>
        </div>
        <div className="p-6 flex flex-col gap-4 min-h-[220px]">
          ...
          >
            <div className="grid grid-cols-[100px_1fr] gap-2">
              <span className="text-foreground/40 text-xs">GITHUB</span>
            ...
            <div className="grid grid-cols-[100px_1fr] gap-2">
              <span className="text-foreground/40 text-xs">TWITTER</span>
              <a href="https://x.com/_mannythegreat_" target="_blank" className="text-primary hover:underline">@_mannythegreat_</a>
            </div>
            <div className="grid grid-cols-[100px_1fr] gap-2">
              <span className="text-foreground/40 text-xs">LINKEDIN</span>
            ...
            <div className="grid grid-cols-[100px_1fr] gap-2">
              <span className="text-foreground/40 text-xs">EMAIL</span>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 2 }}
            className="mt-2 text-foreground/40 italic flex items-center gap-2"
          >
            <span className="text-[#27c93f]">SUCCESS:</span> Connection established.
