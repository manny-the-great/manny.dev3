    ...
    <section id="projects" className="w-full max-w-6xl mx-auto px-6 flex flex-col gap-8">
        ...
        {projects.map((project, i) => {
          ...
          return (
            ...
            >
              ...
              {/* Image area */}
              <div className="relative w-full h-48 overflow-hidden bg-foreground/3">
                <motion.img
                  src={project.image}
                  alt={project.title}
                ...
                <div className="flex items-center gap-4 mt-2 pt-3 border-t border-foreground/6">
                  {project.liveUrl && project.liveUrl !== '#' ? (
                    <a href={project.liveUrl} target="_blank" rel="noopener noreferrer"
                      className="flex items-center gap-1.5 text-xs font-semibold font-heading text-foreground/70 hover:text-primary transition-colors">
      ...
      <div className="flex justify-center">
        <a href="https://github.com/manny-the-great" target="_blank" rel="noopener noreferrer"
          className="group flex items-center gap-2 text-sm font-semibold font-heading text-muted hover:text-foreground transition-colors border-b border-transparent hover:border-foreground/30 pb-0.5">
