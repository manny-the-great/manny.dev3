...
const experiences: ExperienceItem[] = [
  {
    ...
    logoUrl: "/dfw-llc.png",
    logoFallback: "DFW",
    summary: "Developing scalable backend services, full-stack web applications, and automated deployment infrastructure.",
    details: [
      "Engineered robust web applications and backend APIs using modern frameworks and clean architecture.",
      "Built automated CI/CD deployment pipelines and containerized services with Docker.",
      "Developed and integrated RESTful APIs, database solutions, and distributed service components.",
      "Collaborated across cross-functional teams to design, test, and ship high-performance software features.",
    ],
    technologies: ["TypeScript", "React", "Node.js", "Python", "Docker", "CI/CD", "PostgreSQL", "AWS"],
  },
  {
    id: "makro-ltd",
    company: "Makro Ltd.",
