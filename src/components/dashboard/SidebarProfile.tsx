...
export const SidebarProfile = () => {
  ...
  return (
    <motion.div 
      ...
      className="w-full lg:w-80 flex flex-col gap-6 glass-card p-6 h-fit lg:sticky lg:top-24"
    >
        ...
        <div className="flex flex-col gap-2 mt-4">
          ...
          <div className="flex gap-1.5">
            {[1, 2, 3, 4, 5].map((star) => (
              <div 
                key={star}
                className="w-10 h-10 rounded-full bg-foreground/5 border border-border flex items-center justify-center group cursor-pointer hover:bg-foreground/10 transition-colors"
                title={`Rating: 5/5`}
              >
                <Star 
                  size={18}
